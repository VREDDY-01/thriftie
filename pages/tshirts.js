    ...
    <div className="container py-14 px-20 md:px-20 lg:px- md:py-24 mx-auto">
      <div className="flex flex-wrap -m-4">
        <div className="lg:w-1/3 xl:w-1/4 md:w-1/2 p-4 cursor-pointer w-full hover:scale-105 md:text-left text-center">
          ...
          <div className="mt-4">
            <h3 className="md:text-gray-500 md:text-xs tracking-widest title-font mb-1">CATEGORY</h3>
            <h2 className="md:text-gray-900 title-font md:text-lg font-medium">The Catalyzer</h2>
        ...
        <div className="lg:w-1/3 xl:w-1/4 md:w-1/2 p-4 cursor-pointer w-full hover:scale-105 md:text-left text-center">
          ...
          <div className="mt-4">
            <h3 className="md:text-gray-500 md:text-xs tracking-widest title-font mb-1">CATEGORY</h3>
            <h2 className="md:text-gray-900 title-font md:text-lg font-medium">Shooting Stars</h2>
        ...
        <div className="lg:w-1/3 xl:w-1/4 md:w-1/2 p-4 cursor-pointer w-full hover:scale-105 md:text-left text-center">
          ...
          <div className="mt-4">
            <h3 className="md:text-gray-500 md:text-xs tracking-widest title-font mb-1">CATEGORY</h3>
            <h2 className="md:text-gray-900 title-font md:text-lg font-medium">Neptune</h2>
        ...
        <div className="lg:w-1/3 xl:w-1/4 md:w-1/2 p-4 cursor-pointer w-full hover:scale-105 md:text-left text-center">
          ...
          <div className="mt-4">
            <h3 className="md:text-gray-500 md:text-xs tracking-widest title-font mb-1">CATEGORY</h3>
            <h2 className="md:text-gray-900 title-font md:text-lg font-medium">The 400 Blows</h2>
